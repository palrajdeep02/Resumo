      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex justify-between items-end pb-4 border-b border-line gap-4">
          <div>
            ...
            <p className="text-sm text-forest-soft mt-1">Post a new position to attract candidates</p>
          </div>
          <Link
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-wrap gap-2 pt-2">
                {skillsRequired.length === 0 ? (
                  <span className="text-xs text-forest-soft font-medium">Add skills needed for this job role.</span>
                ) : (
          ...
          >
            {isPending ? "Creating Job listing..." : "Publish Job Listing"}
          </button>
        </form>
      </div>
    </div>
